The ChLeadTime.cr script provides a basic method for calculating the Change Lead Time and can be customized to fit different log formats and environments.
